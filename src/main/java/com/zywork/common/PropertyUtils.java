...
public class PropertyUtils {
    ...
    public static String propertyToColumn(String property) {
        List<Character> characterList = com.zywork.common.StringUtils.stringToCharList(property);
        ...
        return com.zywork.common.StringUtils.charListToString(characterList);
    }
