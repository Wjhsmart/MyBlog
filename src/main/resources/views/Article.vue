...
<FormItem label="阅读数" prop="viewCount">
	<InputNumber v-model="form.viewCount" placeholder="请输入阅读数" style="width: 100%;"/>
</FormItem>
<FormItem label="评论数" prop="commentCount">
	<InputNumber v-model="form.commentCount" placeholder="请输入评论数" style="width: 100%;"/>
</FormItem>
<FormItem label="是否推荐" prop="recommend">
	<InputNumber v-model="form.recommend" placeholder="请输入是否推荐" style="width: 100%;"/>
</FormItem>
