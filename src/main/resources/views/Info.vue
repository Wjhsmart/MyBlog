<template>
  <div>
	...
	<Input v-model="form.title" placeholder="请输入系统名称"/>
</FormItem>
<FormItem label="说明" prop="desc">
	<Input v-model="form.desc" placeholder="请输入说明"/>
</FormItem>
<FormItem label="备案号" prop="recordNum">
	<Input v-model="form.recordNum" placeholder="请输入备案号"/>
</FormItem>
<FormItem label="域名" prop="domainName">
	<Input v-model="form.domainName" placeholder="请输入域名"/>
</FormItem>
<FormItem label="姓名" prop="name">
	<Input v-model="form.name" placeholder="请输入姓名"/>
</FormItem>
<FormItem label="真实姓名" prop="rename">
	<Input v-model="form.rename" placeholder="请输入真实姓名"/>
</FormItem>
<FormItem label="网名" prop="netName">
	<Input v-model="form.netName" placeholder="请输入网名"/>
</FormItem>
<FormItem label="职业" prop="vocation">
	<Input v-model="form.vocation" placeholder="请输入职业"/>
</FormItem>
<FormItem label="QQ" prop="qq">
	<Input v-model="form.qq" placeholder="请输入QQ"/>
</FormItem>
<FormItem label="微信" prop="wechat">
	<Input v-model="form.wechat" placeholder="请输入微信"/>
</FormItem>
<FormItem label="邮箱" prop="email">
	<Input v-model="form.email" placeholder="请输入邮箱"/>
</FormItem>
<FormItem label="头像" prop="headImg">
	<Input v-model="form.headImg" placeholder="请输入头像"/>
</FormItem>
<FormItem label="微信二维码" prop="wechatCode">
	<Input v-model="form.wechatCode" placeholder="请输入微信二维码"/>
</FormItem>
<FormItem label="格言" prop="motto">
	<Input v-model="form.motto" placeholder="请输入格言"/>
</FormItem>
  ...
  export default {
    ...
    data() {
      return {
        ...
        urls: {
          addUrl: '/info/admin/save',
          batchAddUrl: '/info/admin/batch-save',
          editUrl: '/info/admin/update',
          batchEditUrl: '/info/admin/batch-update',
          searchUrl: '/info/admin/pager-cond',
          allUrl: '/info/admin/all',
          removeUrl: '/info/admin/remove/',
          batchRemoveUrl: '/info/admin/batch-remove',
          detailUrl: '/info/admin/one/',
          activeUrl: '/info/admin/active',
          batchActiveUrl: '/info/admin/batch-active'
        },
        page: {
          total: 0
        },
