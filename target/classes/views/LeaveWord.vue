<template>
  <div>
	...
	<Input v-model="form.nickname" placeholder="请输入称呼"/>
</FormItem>
<FormItem label="邮箱" prop="email">
	<Input v-model="form.email" placeholder="请输入邮箱"/>
</FormItem>
<FormItem label="回复标识" prop="replyFlag">
	<InputNumber v-model="form.replyFlag" placeholder="请输入回复标识" style="width: 100%;"/>
</FormItem>
...
<FormItem label="是否已读" prop="readFlag">
	<InputNumber v-model="form.readFlag" placeholder="请输入是否已读" style="width: 100%;"/>
</FormItem>
  ...
  export default {
    ...
    data() {
      return {
        ...
        urls: {
          addUrl: '/leave-word/admin/save',
          batchAddUrl: '/leave-word/admin/batch-save',
          editUrl: '/leave-word/admin/update',
          batchEditUrl: '/leave-word/admin/batch-update',
          searchUrl: '/leave-word/admin/pager-cond',
          allUrl: '/leave-word/admin/all',
          removeUrl: '/leave-word/admin/remove/',
          batchRemoveUrl: '/leave-word/admin/batch-remove',
          detailUrl: '/leave-word/admin/one/',
          activeUrl: '/leave-word/admin/active',
          batchActiveUrl: '/leave-word/admin/batch-active'
        },
        page: {
          total: 0
        },
